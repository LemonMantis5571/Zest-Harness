...
#[allow(dead_code, reason = "legacy hand-rolled Responses path; removed in the Rig migration's cleanup phase, kept meanwhile so its tests keep guarding the wire shape")]
