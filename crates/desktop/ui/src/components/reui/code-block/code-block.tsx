...
const ROOT_TOKEN_CLASS = [
  ...
  "[--code-block-diff-add-bg:color-mix(in_oklch,var(--primary)_8%,transparent)]",
  "dark:[--code-block-diff-add-bg:color-mix(in_oklch,var(--primary)_12%,transparent)]",
  ...
  "[--code-block-warning-bg:color-mix(in_oklch,var(--primary)_10%,transparent)]",
  "dark:[--code-block-warning-bg:color-mix(in_oklch,var(--primary)_14%,transparent)]",
  "[--code-block-info-bg:color-mix(in_oklch,var(--primary)_8%,transparent)]",
  "dark:[--code-block-info-bg:color-mix(in_oklch,var(--primary)_12%,transparent)]",
...
const LINE_DIFF_CLASS = [
  ...
  "data-[diff=add]:after:text-primary",
...
function CodeBlock({
  ...
  /* Presentation props enter the effect as ONE memoized options object: inline
     literals at most call sites should not re-tokenize per parent render.
     `transformers` holds functions and stays a reference dep - hoist it to
     module scope. */
  const highlightOptions = useMemo<CodeBlockHighlightOptions>(
    () => ({
  ...
  const specKey = JSON.stringify([
    highlightOptions.themes ?? null,
    highlightOptions.startLine,
    highlightOptions.highlightedLines ?? null,
    highlightOptions.highlightedWords ?? null,
    highlightOptions.focusedLines ?? null,
    highlightOptions.diff ?? null,
    highlightOptions.lineLevels ?? null,
  ])
