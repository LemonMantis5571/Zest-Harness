...
export function NeedsInputCard({
  ...
  const showHeader = isQuestion || (!isQuestion && pendingApprovalCount > 1);
  ...
  return (
    <div
      ...
      className="pointer-events-auto mx-auto w-full max-w-[var(--chat-max)] overflow-visible rounded-xl border border-border/70 bg-[color-mix(in_srgb,var(--card)_94%,transparent)] p-2.5 shadow-lg backdrop-blur-xl"
    >
      {showHeader ? (
