 ...
 *
 * Anything unrecognised gets a generic server icon. That is the normal case
 * for a local model, not a failure — a provider Zest has never heard of should
 * look deliberately plain, not broken.
 */
